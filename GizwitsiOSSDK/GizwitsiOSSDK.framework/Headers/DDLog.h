 ...
 * static const int _ddLogLevel = LOG_LEVEL_VERBOSE;
 * 
 * Step 2 [3rd party frameworks]:
 *
 * Define your LOG_LEVEL_DEF to a different variable/function than _ddLogLevel:
 *
...
**/
    ...
    #define LOG_LEVEL_DEF _ddLogLevel
#endif
 ...
 * 
 * if (logFlagForThisLogMsg & _ddLogLevel) { execute log message }
 * 
 * When LOG_LEVEL_DEF is defined as _ddLogLevel.
 *
 ...
 * 
 * (If the compiler sees _ddLogLevel declared as a constant, the compiler simply checks to see if the 'if' statement
 ...
 * 
 * static const int _ddLogLevel = LOG_FLAG_ERROR | LOG_FLAG_INFO;
 * 
 * When LOG_LEVEL_DEF is defined as _ddLogLevel.
 *
