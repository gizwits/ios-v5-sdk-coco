...
extern NSString *const _GCDAsyncUdpSocketException;
extern NSString *const _GCDAsyncUdpSocketErrorDomain;

extern NSString *const _GCDAsyncUdpSocketQueueName;
extern NSString *const _GCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(_GCDAsyncUdpSocketErrorDomain, _GCDAsyncUdpSocketError) {
...
@class _GCDAsyncUdpSocket;

@protocol _GCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(_GCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(_GCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(_GCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(_GCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(_GCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(_GCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * 
**/
typedef BOOL (^_GCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^_GCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface _GCDAsyncUdpSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<_GCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<_GCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)setSendFilter:(nullable _GCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable _GCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable _GCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable _GCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
