...
static BOOL const _MQTT_PERSISTENT = NO;
static NSInteger const _MQTT_MAX_SIZE = 64 * 1024 * 1024;
static NSInteger const _MQTT_MAX_WINDOW_SIZE = 16;
static NSInteger const _MQTT_MAX_MESSAGES = 1024;
 ...
 */
- (id<_MQTTFlow>)storeMessageForClientId:(NSString *)clientId
 ...
 */
- (void)deleteFlow:(id<_MQTTFlow>)flow;
 ...
 */
- (id<_MQTTFlow>)flowforClientId:(NSString *)clientId
                   incomingFlag:(BOOL)incomingFlag
